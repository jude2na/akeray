...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false)
      if (formData.email === "aseffa@akeray.et" && formData.password === "admin123") {
        toast({
          title: "Login Successful",
          description: "Welcome to Akeray Property Management System",
        })
        router.push("/dashboard/admin")
      } else if (formData.email === "mulugeta@akeray.et" && formData.password === "owner123") {
        toast({
          title: "Login Successful",
          description: "Welcome to Property Owner Dashboard",
        })
        router.push("/dashboard/owner")
      } else if (formData.email === "meron@akeray.et" && formData.password === "tenant123") {
        toast({
          title: "Login Successful",
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-blue-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-8 relative z-10">
        ...
        <div className="text-center animate-in fade-in duration-1000">
          ...
          <p className="text-lg text-gray-600 font-medium">Property Management System</p>
          <p className="text-sm text-gray-500">Efficient Property Management for Ethiopia</p>
        </div>
        ...
        <Card className="shadow-2xl border-0 backdrop-blur-sm bg-white/95 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-300">
          ...
          <CardContent className="space-y-6">
            {error && (
              <Alert variant="destructive" className="animate-in fade-in duration-300 border-red-200 bg-red-50">
            ...
            <div className="text-center text-sm text-gray-500 border-t pt-6">
              ...
              <a href="mailto:support@akeray.et" className="text-emerald-600 hover:underline font-semibold">
                support@akeray.et
              </a>
            </div>
