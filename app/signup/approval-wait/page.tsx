...
import { Clock, CheckCircle, Mail, MessageSquare, ArrowLeft, Home } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-blue-50 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl space-y-8">
        ...
        <div className="text-center animate-in fade-in duration-1000">
          ...
          <p className="text-xl text-gray-600 mb-2">Thank you for joining the Akeray community</p>
        </div>
          ...
          <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Our team will verify your submitted documents and information</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">We'll conduct a quick background verification for security</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">You'll receive SMS and email confirmation once approved</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-yellow-50 p-6 rounded-2xl border border-yellow-200">
              <div className="flex items-center space-x-3 mb-3">
                ...
                <h3 className="text-lg font-semibold text-yellow-800">Expected Timeline</h3>
              </div>
              <p className="text-yellow-700 font-medium text-lg">
                ⏰ Approval typically takes 30 minutes to 2 hours
              </p>
              <p className="text-yellow-600 text-sm mt-2">
                You'll receive notifications via SMS and email once your account is approved
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-emerald-50 p-4 rounded-xl border border-emerald-200">
                <div className="flex items-center space-x-3 mb-2">
                  ...
                  <h4 className="font-semibold text-emerald-800">Email Notification</h4>
                </div>
                <p className="text-emerald-700 text-sm">
                  Check your email for detailed account information and next steps
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-2xl border border-gray-200">
              ...
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start space-x-2">
                  ...
                  <span className="text-sm">Keep your phone accessible for SMS notifications</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-emerald-500 font-bold">•</span>
                  <span className="text-sm">Check your email spam folder if you don't receive confirmation</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-emerald-500 font-bold">•</span>
                  <span className="text-sm">You can try logging in once you receive approval notification</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-emerald-500 font-bold">•</span>
                  <span className="text-sm">Contact support if you don't hear back within 24 hours</span>
                </li>
              </ul>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button asChild className="flex-1 h-12 bg-gradient-to-r from-emerald-600 to-blue-600 hover:from-emerald-700 hover:to-blue-700">
                <Link href="/login">
                  Try Login (After Approval)
                </Link>
              </Button>
              <Button variant="outline" asChild className="flex-1 h-12 border-emerald-300 hover:bg-emerald-50">
