    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-blue-50 flex items-center justify-center p-4">
      <div className="w-full max-w-4xl space-y-8">
        ...
        <div className="text-center animate-in fade-in duration-1000">
          ...
          <p className="text-xl text-gray-600 mb-2">Choose how you'd like to get started</p>
          <p className="text-sm text-gray-500">Select your role to create the right account for your needs</p>
        </div>
          ...
          <Card className="group hover:shadow-2xl transition-all duration-500 transform hover:scale-105 bg-white/95 backdrop-blur-sm border-2 border-emerald-200 hover:border-emerald-400">
            ...
            <CardContent className="space-y-6">
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-emerald-500" />
                  <span className="text-gray-700">Manage tenants and leases</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-emerald-500" />
                  <span className="text-gray-700">Track payments and income</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-emerald-500" />
                  <span className="text-gray-700">Professional property management tools</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-emerald-500" />
                  <span className="text-gray-700">Featured listing opportunities</span>
                </div>
              </div>
              ...
              <div className="bg-emerald-50 p-4 rounded-xl border border-emerald-200">
                ...
                <p className="text-emerald-700 text-sm">
                  Property investors, landlords, and real estate professionals looking to maximize their rental income
                </p>
              </div>

              <Button asChild className="w-full h-14 bg-gradient-to-r from-emerald-600 to-blue-600 hover:from-emerald-700 hover:to-blue-700 text-lg font-semibold shadow-lg">
                <Link href="/signup/owner" className="flex items-center justify-center">
            ...
            <CardContent className="space-y-6">
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">Browse verified properties</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-blue-500" />
                  <span className="text-gray-700">Direct contact with property owners</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-blue-500" />
                  <span className="text-gray-700">Online payment and lease management</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-blue-500" />
                  <span className="text-gray-700">Maintenance request system</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-blue-500" />
              ...
              <div className="bg-blue-50 p-4 rounded-xl border border-blue-200">
                ...
                <p className="text-blue-700 text-sm">
                  Individuals and families looking for apartments, houses, or commercial spaces to rent
                </p>
              </div>

              <Button asChild variant="outline" className="w-full h-14 border-2 border-blue-300 hover:bg-blue-50 text-lg font-semibold">
                <Link href="/signup/tenant" className="flex items-center justify-center text-blue-600">
        ...
        <div className="text-center text-sm text-gray-500 animate-in fade-in duration-1000 delay-800">
          <p>
            ...
            Contact support if you need administrative access.
          </p>
        </div>
      </div>
    </div>
