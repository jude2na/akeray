...
import { Building, ArrowLeft, Save, User, Phone, Mail, Calendar, DollarSign, FileText, CreditCard } from "lucide-react"
...
export default function RentRequestPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validation
    if (!formData.monthlyIncome || !formData.emergencyContactName || !formData.emergencyContactPhone) {
    ...
    setTimeout(() => {
      ...
      if (formData.leaseType === "online") {
        router.push(`/dashboard/tenant/properties/${params.id}/units/${params.unitId}/lease`)
      } else {
    ...
    <DashboardLayout userRole="tenant" userName="Meron Tadesse" userEmail="meron@email.com">
      <div className="space-y-8">
        ...
        <div className="animate-in fade-in duration-1000">
          <div className="flex items-center space-x-4 mb-6">
            <Button variant="outline" asChild className="border-emerald-300 hover:bg-emerald-50">
              <Link href={`/dashboard/tenant/properties/${params.id}/units/${params.unitId}`}>
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            <div className="xl:col-span-2 space-y-8">
              ...
              <div className="animate-in fade-in slide-in-from-left-4 duration-700 delay-300" style={{ animationFillMode: "forwards" }}>
                <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm">
                  <CardHeader>
                    ...
                    <CardDescription>Your basic information for the rental application</CardDescription>
                  </CardHeader>
              ...
              <div className="animate-in fade-in slide-in-from-left-4 duration-700 delay-600" style={{ animationFillMode: "forwards" }}>
                <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm">
                  <CardHeader>
                    <CardTitle className="text-xl font-bold text-gray-900">Rental Preferences</CardTitle>
                    <CardDescription>Your preferences for the lease</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <Label htmlFor="leaseDuration" className="text-sm font-semibold text-gray-700">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="numberOfOccupants" className="text-sm font-semibold text-gray-700">
                          Number of Occupants
                        </Label>
                        <Select value={formData.numberOfOccupants} onValueChange={(value) => setFormData({ ...formData, numberOfOccupants: value })}>
                          <SelectTrigger className="h-12 rounded-xl border-2 border-gray-200 focus:border-emerald-500">
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent>
              ...
              <div className="animate-in fade-in slide-in-from-left-4 duration-700 delay-900" style={{ animationFillMode: "forwards" }}>
                <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm">
                  <CardHeader>
                    <CardTitle className="text-xl font-bold text-gray-900">Emergency Contact & References</CardTitle>
                    <CardDescription>Contact information for verification</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="emergencyContactRelation" className="text-sm font-semibold text-gray-700">
                            Relationship
                          </Label>
                    ...
                    <div className="space-y-4">
                      <h4 className="font-semibold text-gray-900">References (Optional)</h4>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label htmlFor="employerName" className="text-sm font-semibold text-gray-700">
                            Employer Name
                          </Label>
                          <Input
                            id="employerName"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="employerPhone" className="text-sm font-semibold text-gray-700">
                            Employer Phone
                          </Label>
                          <Input
                            id="employerPhone"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="additionalRequests" className="text-sm font-semibold text-gray-700">
              ...
              <div className="animate-in fade-in slide-in-from-left-4 duration-700 delay-1200" style={{ animationFillMode: "forwards" }}>
                <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm">
                  <CardHeader>
                    <CardTitle className="text-xl font-bold text-gray-900">Lease Processing Method</CardTitle>
                    <CardDescription>Choose how you'd like to complete the lease agreement</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <RadioGroup
                          ...
                          <Label htmlFor="online" className="flex-1 cursor-pointer">
                            <div className="p-4 rounded-xl border-2 border-gray-200 hover:border-emerald-300 transition-colors">
                              <div className="flex items-center space-x-3">
                                ...
                                <div>
                                  <p className="font-semibold text-gray-900">Online Lease Agreement</p>
                                  <p className="text-sm text-gray-600">Complete everything digitally with online payment</p>
                                  <p className="text-xs text-emerald-600 font-medium">✓ Faster processing • ✓ Instant confirmation</p>
                                </div>
                              </div>
                            </div>
                          </Label>
                          ...
                          <Label htmlFor="in-person" className="flex-1 cursor-pointer">
                            <div className="p-4 rounded-xl border-2 border-gray-200 hover:border-blue-300 transition-colors">
                              <div className="flex items-center space-x-3">
                                ...
                                <div>
                                  <p className="font-semibold text-gray-900">In-Person Meeting</p>
                                  <p className="text-sm text-gray-600">Schedule a meeting with the property manager</p>
                                  <p className="text-xs text-blue-600 font-medium">✓ Personal consultation • ✓ Property tour included</p>
                                </div>
                              </div>
                            </div>
                          </Label>
              ...
              <div className="animate-in fade-in slide-in-from-left-4 duration-700 delay-1500" style={{ animationFillMode: "forwards" }}>
                <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm">
                  <CardHeader>
                    <CardTitle className="text-xl font-bold text-gray-900">Terms and Conditions</CardTitle>
                    <CardDescription>Please read and agree to the following</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <Label htmlFor="agreeToTerms" className="text-sm text-gray-700 cursor-pointer leading-relaxed">
                        I agree to the lease terms and conditions, including the monthly rent of {data.unit.monthlyRent.toLocaleString()} ETB and security deposit of {data.unit.deposit.toLocaleString()} ETB. I understand that providing false information may result in application rejection.
                      </Label>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => setFormData({ ...formData, agreeToBackgroundCheck: checked as boolean })}
                        className="mt-1"
                      />
                      <Label htmlFor="agreeToBackgroundCheck" className="text-sm text-gray-700 cursor-pointer leading-relaxed">
                        I consent to background verification, credit checks, and reference verification as required by the property owner for rental approval.
                      </Label>
                    </div>
                  </CardContent>
                </Card>
            ...
            <div className="xl:col-span-1 space-y-8">
              ...
              <div className="animate-in fade-in slide-in-from-right-4 duration-700 delay-600" style={{ animationFillMode: "forwards" }}>
                <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm sticky top-8">
                  <CardHeader>
                    <CardTitle className="text-xl font-bold text-gray-900">Application Summary</CardTitle>
                    <CardDescription>Review your rental application</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="bg-blue-50 p-4 rounded-xl border border-blue-200">
                      <h4 className="font-semibold text-blue-800 mb-3">Unit Details</h4>
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          <span className="text-blue-700">Property:</span>
                          <span className="text-blue-600 font-medium">{data.property.name}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-blue-700">Unit:</span>
                          <span className="text-blue-600 font-medium">{data.unit.unitNumber}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-blue-700">Available From:</span>
                          <span className="text-blue-600 font-medium">{new Date(data.unit.availableFrom).toLocaleDateString()}</span>
                        </div>
                      </div>
                    </div>

                    <div className="bg-emerald-50 p-4 rounded-xl border border-emerald-200">
                      <h4 className="font-semibold text-emerald-800 mb-3">Financial Summary</h4>
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          <span className="text-emerald-700">Monthly Rent:</span>
                          <span className="text-emerald-600 font-medium">{data.unit.monthlyRent.toLocaleString()} ETB</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-emerald-700">Security Deposit:</span>
                          <span className="text-emerald-600 font-medium">{data.unit.deposit.toLocaleString()} ETB</span>
                        </div>
                        <div className="border-t border-emerald-200 pt-2 mt-2">
                          <div className="flex justify-between">
                            <span className="text-emerald-700 font-semibold">Total Upfront:</span>
                            <span className="text-emerald-600 font-bold text-lg">{totalUpfront.toLocaleString()} ETB</span>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          {/* Submit Button */}
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 delay-1800" style={{ animationFillMode: "forwards" }}>
