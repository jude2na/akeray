...
import { FileText, Download, ArrowLeft, CreditCard, CheckCircle, Calendar, Building } from "lucide-react"
...
export default function OnlineLeaseAgreementPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validation
    if (!formData.agreeToTerms || !formData.paymentMethod || !formData.digitalSignature || !formData.confirmDetails) {
    ...
    setTimeout(() => {
      ...
      router.push(`/dashboard/tenant/properties/${params.id}/units/${params.unitId}/payment`)
    }, 2000)
  }
        ...
        <div className="animate-in fade-in duration-1000">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600">
              Review and sign your lease agreement for Unit {data.unit.unitNumber}
            </p>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            <div className="xl:col-span-2 space-y-8">
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                      <div className="space-y-2">
                        <p className="text-sm font-medium text-gray-500">Property & Unit</p>
                        <p className="text-lg font-semibold text-gray-900">{data.property.name}</p>
                        <p className="text-sm text-gray-600">Unit {data.unit.unitNumber}</p>
                      </div>
                      <div className="space-y-2">
                        <p className="text-sm font-medium text-gray-500">Lease Period</p>
                        <p className="text-sm font-semibold text-gray-900">{new Date(data.lease.startDate).toLocaleDateString()}</p>
                        <p className="text-sm text-gray-600">to {new Date(data.lease.endDate).toLocaleDateString()}</p>
                      </div>
                      <div className="space-y-2">
                        <p className="text-sm font-medium text-gray-500">Monthly Rent</p>
                        <p className="text-lg font-bold text-emerald-600">{data.unit.monthlyRent.toLocaleString()} ETB</p>
                        <p className="text-sm text-gray-600">Due on {data.lease.paymentDueDate}{data.lease.paymentDueDate === 1 ? 'st' : 'th'} of month</p>
                      </div>
                      <div className="space-y-2">
                        <p className="text-sm font-medium text-gray-500">Security Deposit</p>
                        <p className="text-lg font-bold text-blue-600">{data.unit.deposit.toLocaleString()} ETB</p>
              ...
              <div className="animate-in fade-in slide-in-from-left-4 duration-700 delay-600" style={{ animationFillMode: "forwards" }}>
                <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm">
                  <CardHeader>
                    <CardTitle className="text-xl font-bold text-gray-900">Lease Terms & Conditions</CardTitle>
                    <CardDescription>Please read all terms carefully before signing</CardDescription>
                  </CardHeader>
                  <CardContent>
                    ...
                    <div className="mt-6 pt-6 border-t">
                      <div className="flex items-start space-x-3">
                        ...
                        <Label htmlFor="agreeToTerms" className="text-sm text-gray-700 cursor-pointer leading-relaxed">
                          I have read, understood, and agree to all the lease terms and conditions listed above. I acknowledge that this constitutes a legally binding agreement.
                        </Label>
                      </div>
                    </div>
                  </CardContent>
              ...
              <div className="animate-in fade-in slide-in-from-left-4 duration-700 delay-900" style={{ animationFillMode: "forwards" }}>
                <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm">
                  <CardHeader>
                    <CardTitle className="text-xl font-bold text-gray-900">Digital Signature</CardTitle>
                    <CardDescription>Sign the lease agreement digitally</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="digitalSignature" className="text-sm font-semibold text-gray-700">
                      ...
                      <p className="text-xs text-gray-500">
                        By typing your name above, you agree that this serves as your legal digital signature
                      </p>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => setFormData({ ...formData, confirmDetails: checked as boolean })}
                        className="mt-1"
                      />
                      <Label htmlFor="confirmDetails" className="text-sm text-gray-700 cursor-pointer leading-relaxed">
                        I confirm that all information provided in this application is accurate and complete. I understand that any false information may result in lease termination.
                      </Label>
                    </div>
                  </CardContent>
                </Card>
            ...
            <div className="xl:col-span-1 space-y-8">
              ...
              <div className="animate-in fade-in slide-in-from-right-4 duration-700 delay-600" style={{ animationFillMode: "forwards" }}>
                <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm sticky top-8">
                  <CardHeader>
                    ...
                    <CardDescription>Amount due upon lease signing</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="space-y-3">
                      <div className="flex justify-between items-center p-3 rounded-xl bg-emerald-50 border border-emerald-200">
                        <span className="text-sm font-medium text-emerald-700">First Month Rent:</span>
                        <span className="font-semibold text-emerald-600">{data.unit.monthlyRent.toLocaleString()} ETB</span>
                      </div>
                      ...
                      <div className="flex justify-between items-center p-3 rounded-xl bg-blue-50 border border-blue-200">
                        ...
                        <span className="font-semibold text-blue-600">{data.unit.deposit.toLocaleString()} ETB</span>
                      </div>
                      ...
                      <div className="border-t pt-3">
                        <div className="flex justify-between items-center p-4 rounded-xl bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-200">
                          ...
                          <span className="text-2xl font-bold text-purple-600">{totalAmount.toLocaleString()} ETB</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-yellow-50 p-4 rounded-xl border border-yellow-200">
                      ...
                      <ul className="text-yellow-700 text-sm space-y-1">
                        ...
                        <li>• Keys will be provided after payment confirmation</li>
              ...
              <div className="animate-in fade-in slide-in-from-right-4 duration-700 delay-900" style={{ animationFillMode: "forwards" }}>
                <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm">
                  <CardHeader>
                    <CardTitle className="text-xl font-bold text-gray-900">After Signing</CardTitle>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">Complete payment for first month rent and deposit</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <p className="font-medium text-gray-900">Lease Activation</p>
                          <p className="text-sm text-gray-600">Your lease will be activated and added to your dashboard</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <p className="font-medium text-gray-900">Key Collection</p>
                          <p className="text-sm text-gray-600">Schedule key pickup and move-in inspection</p>
                        </div>
                      </div>
                    </div>
                  </CardContent>
