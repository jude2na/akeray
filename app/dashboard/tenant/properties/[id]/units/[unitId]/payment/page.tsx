...
import { CreditCard, ArrowLeft, CheckCircle, Building, DollarSign, Calendar } from "lucide-react"
        ...
        <div className="animate-in fade-in duration-1000">
          <div className="flex items-center space-x-4 mb-6">
            <Button variant="outline" asChild className="border-emerald-300 hover:bg-emerald-50">
              <Link href={`/dashboard/tenant/properties/${params.id}/units/${params.unitId}/lease`}>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-600">Rent: {data.unit.monthlyRent.toLocaleString()} ETB</p>
                        <p className="text-sm text-gray-600">Deposit: {data.unit.deposit.toLocaleString()} ETB</p>
                      </div>
                      <div className="space-y-2">
                        <p className="text-sm font-medium text-gray-500">Total Amount</p>
                        <p className="text-2xl font-bold text-emerald-600">{totalAmount.toLocaleString()} ETB</p>
                      ...
                      <div className="mt-6 p-4 rounded-xl bg-blue-50 border border-blue-200">
                        ...
                        {selectedMethod.value === "bank_transfer" && (
                          <div className="text-blue-700 text-sm space-y-1">
                            ...
                            <p>• Reference: Unit {data.unit.unitNumber} - {data.property.name}</p>
                          </div>
                        )}
                        {selectedMethod.value === "mobile_money" && (
                          <div className="text-blue-700 text-sm space-y-1">
                            ...
                            <p>• Amount: {totalAmount.toLocaleString()} ETB</p>
                            <p>• Reference: Unit {data.unit.unitNumber} - Your Name</p>
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-semibold">{data.unit.monthlyRent.toLocaleString()} ETB</span>
                      </div>
                      
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">Security Deposit:</span>
                        <span className="font-semibold">{data.unit.deposit.toLocaleString()} ETB</span>
                      </div>

                      <div className="border-t pt-3">
                        <div className="flex justify-between items-center">
                          <span className="text-lg font-bold text-gray-900">Total Amount:</span>
                          <span className="text-2xl font-bold text-emerald-600">{totalAmount.toLocaleString()} ETB</span>
                        </div>
                      </div>
                    </div>

                    <div className="bg-emerald-50 p-4 rounded-xl border border-emerald-200">
                      <h4 className="font-semibold text-emerald-800 mb-2">✓ Lease Agreement Signed</h4>
                      <p className="text-emerald-700 text-sm">
                        Your digital lease agreement has been successfully signed and is now active.
                      </p>
                    </div>

                    <div className="bg-yellow-50 p-4 rounded-xl border border-yellow-200">
                      <h4 className="font-semibold text-yellow-800 mb-2">Payment Verification</h4>
