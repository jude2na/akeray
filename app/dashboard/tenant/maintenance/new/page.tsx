...
import { Wrench, Building, ArrowLeft, Save, Camera, Upload, X } from "lucide-react"
      ...
      <div className="space-y-8">
        ...
        <div className="animate-in fade-in duration-1000">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600">Report an issue that needs attention in your apartment</p>
            <p className="text-sm text-gray-500">Provide detailed information to help us resolve the issue quickly</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            <div className="xl:col-span-2 space-y-8">
              ...
              <div className="animate-in fade-in slide-in-from-left-4 duration-700 delay-300" style={{ animationFillMode: "forwards" }}>
                <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm">
                  <CardHeader>
                    ...
                    <CardDescription>Describe the maintenance issue you're experiencing</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    ...
                    <div className="bg-blue-50 p-4 rounded-xl border border-blue-200">
                      <div className="flex items-center space-x-3 mb-3">
                        ...
                        <h4 className="font-semibold text-blue-800">Your Property Information</h4>
                      </div>
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          <p className="text-blue-700 font-medium">Property:</p>
                          <p className="text-blue-600">{tenantPropertyInfo.property}</p>
                        </div>
                        <div>
                          <p className="text-blue-700 font-medium">Unit:</p>
                          <p className="text-blue-600">{tenantPropertyInfo.unit}</p>
                        </div>
                      </div>
                    </div>
              ...
              <div className="animate-in fade-in slide-in-from-left-4 duration-700 delay-600" style={{ animationFillMode: "forwards" }}>
                <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm">
                  <CardHeader>
                    <CardTitle className="text-xl font-bold text-gray-900">Category & Priority</CardTitle>
                    <CardDescription>Help us categorize and prioritize your request</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
              ...
              <div className="animate-in fade-in slide-in-from-left-4 duration-700 delay-900" style={{ animationFillMode: "forwards" }}>
                <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm">
                  <CardHeader>
                    <CardTitle className="text-xl font-bold text-gray-900">Photos (Optional)</CardTitle>
                    <CardDescription>Upload photos to help us understand the issue better (Max 5 images)</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-emerald-400 transition-colors">
                      <Camera className="mx-auto h-10 w-10 text-gray-400 mb-3" />
                      <div className="space-y-2">
                        <p className="text-sm font-medium text-gray-700">Upload photos of the issue</p>
              ...
              <div className="animate-in fade-in slide-in-from-right-4 duration-700 delay-600" style={{ animationFillMode: "forwards" }}>
                <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm sticky top-8">
                  <CardHeader>
                    ...
                    <CardDescription>Review your maintenance request</CardDescription>
                  </CardHeader>
                  ...
                  <CardContent>
                    <div className="bg-red-50 p-4 rounded-xl border border-red-200">
                      ...
                      <p className="text-red-700 text-sm mb-3">
                        For water leaks, electrical hazards, or security issues, call immediately:
                      </p>
                      <div className="space-y-2">
                        <div className="flex items-center space-x-2">
                          <span className="text-red-600 font-bold">📞</span>
                          <span className="font-semibold text-red-800">{tenantPropertyInfo.landlordPhone}</span>
                        </div>
                        <div className="flex items-center space-x-2">
                          <span className="text-red-600 font-bold">🏠</span>
                          <span className="text-red-700 text-sm">{tenantPropertyInfo.landlord}</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
