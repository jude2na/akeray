...
import { Building, ArrowLeft, Calendar, DollarSign, Phone, Mail, FileText, Wrench, User } from "lucide-react"
...
const getMyPropertyData = (id: string) => ({
  ...
  unitDetails: {
    ...
    floor: 3,
    furnished: false,
    amenities: ["City View", "Large Living Room", "Storage Space", "Modern Kitchen", "Private Balcony"]
  },
  recentPayments: [
    { month: "December 2024", amount: 18000, status: "paid", date: "2024-12-01", method: "Bank Transfer" },
    { month: "November 2024", amount: 18000, status: "paid", date: "2024-11-01", method: "Bank Transfer" },
    { month: "October 2024", amount: 18000, status: "paid", date: "2024-10-01", method: "Cash" },
  ],
  maintenanceRequests: [
    { id: "MNT-001", title: "Kitchen faucet leak", status: "completed", date: "2024-12-15", priority: "medium" },
    { id: "MNT-002", title: "Bedroom light fixture", status: "in_progress", date: "2024-12-20", priority: "low" },
  ],
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-gray-500 flex items-center mt-1">
                ...
                Lease: {new Date(property.leaseStart).toLocaleDateString()} - {new Date(property.leaseEnd).toLocaleDateString()}
              </p>
            </div>
            <div className="flex space-x-3">
              ...
              >
                <Link href={`/dashboard/tenant/my-properties/${property.id}/maintenance/new`}>
              ...
              >
                <Link href={`/dashboard/tenant/my-properties/${property.id}/payments/new`}>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="space-y-2">
                  ...
                  <p className="text-2xl font-bold text-emerald-600">{property.monthlyRent.toLocaleString()} ETB</p>
                  <p className="text-sm text-gray-600">Due: {new Date(property.nextPayment).toLocaleDateString()}</p>
                </div>
                <div className="space-y-2">
                  <p className="text-sm font-medium text-gray-500">Unit Details</p>
                  <p className="text-lg font-semibold text-gray-900">{property.unitDetails.area}</p>
                  <p className="text-sm text-gray-600">{property.unitDetails.bedrooms} bed • {property.unitDetails.bathrooms} bath</p>
                </div>
                <div className="space-y-2">
                  <p className="text-sm font-medium text-gray-500">Lease Status</p>
                  <Badge className="bg-emerald-100 text-emerald-800 font-semibold">{property.status}</Badge>
                  <p className="text-sm text-gray-600">{property.daysRemaining} days remaining</p>
                </div>
                <div className="space-y-2">
                  <p className="text-sm font-medium text-gray-500">Payment Status</p>
                  <Badge className="bg-emerald-100 text-emerald-800 font-semibold">{property.paymentStatus}</Badge>
                  <p className="text-sm text-gray-600">Last: {new Date(property.lastPayment).toLocaleDateString()}</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
          ...
          <div className="animate-in fade-in slide-in-from-left-4 duration-700 delay-600" style={{ animationFillMode: "forwards" }}>
            <Card className="shadow-xl border-0 bg-white/90 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-xl font-bold text-gray-900">Lease Information</CardTitle>
                <CardDescription>Your current lease details and progress</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm text-gray-500">{property.daysRemaining} days remaining</span>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center p-3 rounded-xl bg-blue-50 border border-blue-200">
                      <p className="text-lg font-bold text-blue-600">{property.unitDetails.bedrooms}</p>
                    ...
                    <div className="text-center p-3 rounded-xl bg-purple-50 border border-purple-200">
                      <p className="text-lg font-bold text-purple-600">{property.unitDetails.bathrooms}</p>
                    ...
                    <div className="text-center p-3 rounded-xl bg-emerald-50 border border-emerald-200">
                      <p className="text-lg font-bold text-emerald-600">{property.unitDetails.area}</p>
                    ...
                    <div className="text-center p-3 rounded-xl bg-orange-50 border border-orange-200">
                      <p className="text-lg font-bold text-orange-600">{property.unitDetails.floor}</p>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    {property.unitDetails.amenities.map((amenity, index) => (
                      <div key={index} className="flex items-center space-x-2 p-2 rounded-lg bg-emerald-50 border border-emerald-100">
          ...
          <div className="space-y-8">
            ...
            <div className="animate-in fade-in slide-in-from-right-4 duration-700 delay-800" style={{ animationFillMode: "forwards" }}>
              <Card className="shadow-xl border-0 bg-white/90 backdrop-blur-sm">
                <CardHeader>
                  ...
                  <CardDescription>Contact information for your landlord</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center space-x-4 p-4 rounded-xl bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-100">
                      ...
                      <div className="flex-1">
                        <p className="font-semibold text-lg text-gray-900">{property.landlord.name}</p>
                        <p className="text-sm text-gray-600">Property Owner</p>
                        <p className="text-sm text-purple-600 font-medium">{property.landlord.company}</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center space-x-3 p-3 rounded-xl hover:bg-gray-50 transition-colors">
                        ...
                        <div>
                          <p className="text-sm font-medium text-gray-900">{property.landlord.phone}</p>
                      ...
                      <div className="flex items-center space-x-3 p-3 rounded-xl hover:bg-gray-50 transition-colors">
                        ...
                        <div>
                          <p className="text-sm font-medium text-gray-900">{property.landlord.email}</p>
            ...
            {/* Quick Actions */}
            <div className="animate-in fade-in slide-in-from-right-4 duration-700 delay-1000" style={{ animationFillMode: "forwards" }}>
              <Card className="shadow-xl border-0 bg-white/90 backdrop-blur-sm">
                <CardHeader>
                ...
                <CardContent>
                  <div className="grid grid-cols-2 gap-4">
                    <Button
                      ...
                      asChild
                    >
                      <Link href={`/dashboard/tenant/my-properties/${property.id}/payments`}>
                    ...
                    <Button
                      ...
                      asChild
                    >
                      <Link href={`/dashboard/tenant/my-properties/${property.id}/maintenance`}>
                    ...
                    <Button
                      ...
                      asChild
                    >
                      <Link href={`/dashboard/tenant/my-properties/${property.id}/lease`}>
          ...
          <div className="animate-in fade-in slide-in-from-right-4 duration-700 delay-1400" style={{ animationFillMode: "forwards" }}>
            <Card className="shadow-xl border-0 bg-white/90 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardDescription>Recent maintenance for this property</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
