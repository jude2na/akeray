...
import { FileText, Search, Filter, Eye, Clock, CheckCircle, AlertCircle, Calendar, Building } from "lucide-react"
...
const rentalRequests = [
  ...
  },
  {
    ...
    response: "Approved! Please contact us to schedule the lease signing meeting.",
  },
  {
    id: "REQ-003",
    ...
    response: "Unfortunately, the unit has been rented to another applicant.",
  },
]
        ...
        <div className="animate-in fade-in duration-1000">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-lg text-gray-600">Track your rental applications and their status</p>
              <p className="text-sm text-gray-500">View responses from property owners and next steps</p>
            </div>
          </div>
        </div>
                  ...
                  {filteredRequests.map((request) => {
                    ...
                    return (
                      <TableRow key={request.id} className="hover:bg-gray-50">
                        ...
                        <TableCell>
                          <span className="font-semibold">{request.monthlyRent.toLocaleString()} ETB</span>
                        </TableCell>
                        <TableCell>
                        ...
                        <TableCell>
                          <span className="text-sm">{new Date(request.moveInDate).toLocaleDateString()}</span>
                        </TableCell>
                        <TableCell>
                          <Badge variant="outline" className="capitalize">
                            {request.leaseType.replace('-', ' ')}
                          </Badge>
                        </TableCell>
                        <TableCell>
                          <div className="flex items-center space-x-2">
