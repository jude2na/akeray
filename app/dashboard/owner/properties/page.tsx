...
import { Building, Plus, Search, Filter, Eye, Edit, MapPin, Users, DollarSign, TrendingUp } from "lucide-react"
        ...
        <div className="animate-in fade-in duration-1000">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-lg text-gray-600">Manage and monitor your property portfolio</p>
              <p className="text-sm text-gray-500">Track performance, occupancy, and revenue across all properties</p>
            </div>
            <Button
              asChild
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div className="space-y-3">
                    ...
                    <p className="text-3xl font-bold text-gray-900">{properties.reduce((sum, p) => sum + p.totalUnits, 0)}</p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div className="space-y-3">
                    ...
                    <p className="text-3xl font-bold text-gray-900">{(properties.reduce((sum, p) => sum + p.monthlyRevenue, 0) / 1000).toFixed(0)}K ETB</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-3">
                    ...
                    <p className="text-3xl font-bold text-gray-900">
                      {Math.round(properties.reduce((sum, p) => sum + getOccupancyRate(p.occupiedUnits, p.totalUnits), 0) / properties.length)}%
                    </p>
                  </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredProperties.map((property, index) => (
            <div
              ...
              style={{ animationDelay: `${index * 150 + 1100}ms`, animationFillMode: "forwards" }}
            >
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-4 text-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium">{(property.monthlyRevenue / 1000).toFixed(0)}K ETB</p>
