...
import { Building, MapPin, DollarSign, Users, Edit, Trash2, Eye, Star, Calendar, TrendingUp, ArrowLeft } from "lucide-react"
...
const propertyData = {
  ...
  description: "Modern apartment complex located in the heart of Bole, featuring contemporary amenities and excellent connectivity to major business districts. Perfect for professionals and families seeking comfort and convenience.",
  type: "Apartment",
  ...
  amenities: ["24/7 Security", "Parking Space", "WiFi Ready", "Backup Generator", "Water Tank", "Elevator", "Modern Kitchen"],
...
export default function PropertyDetailsPage() {
  ...
  const occupancyRate = Math.round((propertyData.occupiedUnits / propertyData.totalUnits) * 100)
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <div className="flex items-center space-x-4 mt-2">
                <Badge className="bg-emerald-100 text-emerald-800">{propertyData.type}</Badge>
                <Badge className="bg-blue-100 text-blue-800">{propertyData.status}</Badge>
            ...
            <div className="flex space-x-3">
              ...
              <AlertDialog>
                <AlertDialogTrigger asChild>
                  <Button variant="outline" className="border-red-300 hover:bg-red-50 text-red-600">
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      Are you sure you want to delete "{propertyData.name}"? This action cannot be undone and will affect all associated leases and tenants.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
                    <AlertDialogCancel>Cancel</AlertDialogCancel>
                    <AlertDialogAction className="bg-red-600 hover:bg-red-700">Delete Property</AlertDialogAction>
                  </AlertDialogFooter>
                </AlertDialogContent>
              </AlertDialog>
            </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          <div className="xl:col-span-2 space-y-8">
            ...
            <div className="animate-in fade-in slide-in-from-left-4 duration-700 delay-300" style={{ animationFillMode: "forwards" }}>
              <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm">
                <CardHeader>
                  ...
                  <CardDescription>Visual showcase of your property</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="relative">
                      <img
                        ...
                        alt={`${propertyData.name} - Image ${selectedImage + 1}`}
                ...
                <CardContent>
                  ...
                  <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="text-center p-4 rounded-xl bg-emerald-50 border border-emerald-200">
                      ...
                      <p className="text-2xl font-bold text-emerald-600">{propertyData.totalUnits}</p>
                    ...
                    <div className="text-center p-4 rounded-xl bg-purple-50 border border-purple-200">
                      ...
                      <p className="text-2xl font-bold text-purple-600">{(propertyData.monthlyRevenue / 1000).toFixed(0)}K</p>
                    ...
                    <div className="text-center p-4 rounded-xl bg-yellow-50 border border-yellow-200">
                      ...
                      <p className="text-2xl font-bold text-yellow-600">{propertyData.rating}</p>
                      <p className="text-sm text-yellow-700">{propertyData.reviews} Reviews</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <div className="animate-in fade-in slide-in-from-left-4 duration-700 delay-900" style={{ animationFillMode: "forwards" }}>
              <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm">
                <CardHeader>
                  <CardTitle className="text-xl font-bold text-gray-900">Current Tenants</CardTitle>
                  <CardDescription>Active tenants in this property</CardDescription>
                </CardHeader>
                <CardContent>
                  <Table>
                    <TableHeader>
                    ...
                    <TableBody>
                      {tenants.map((tenant) => (
                        <TableRow key={tenant.id} className="hover:bg-gray-50">
                          ...
                          <TableCell>
                            <Badge className="bg-blue-100 text-blue-800">Unit {tenant.unit}</Badge>
                          </TableCell>
                          <TableCell>
                          ...
                          <TableCell>
                            <span className="font-semibold">{tenant.monthlyRent.toLocaleString()} ETB</span>
                          </TableCell>
                          <TableCell>
                            <Badge className="bg-emerald-100 text-emerald-800">{tenant.status}</Badge>
                          </TableCell>
          ...
          <div className="xl:col-span-1 space-y-8">
            ...
            <div className="animate-in fade-in slide-in-from-right-4 duration-700 delay-600" style={{ animationFillMode: "forwards" }}>
              <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm sticky top-8">
                <CardHeader>
                  <CardTitle className="text-xl font-bold text-gray-900">Property Statistics</CardTitle>
                  <CardDescription>Performance metrics and details</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-lg font-bold text-emerald-600">{occupancyRate}%</span>
                    </div>
                    <Progress value={occupancyRate} className="h-3" />
                    <p className="text-xs text-gray-500">{propertyData.occupiedUnits} of {propertyData.totalUnits} units occupied</p>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold text-emerald-600">{propertyData.monthlyRevenue.toLocaleString()} ETB</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm text-gray-600">Price per Unit:</span>
                        <span className="font-medium">{propertyData.pricePerUnit.toLocaleString()} ETB</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm text-gray-600">Annual Revenue:</span>
                        <span className="font-medium">{(propertyData.monthlyRevenue * 12).toLocaleString()} ETB</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{propertyData.squareMeters} sqm</span>
                      </div>
                      <div className="flex justify-between">
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      {propertyData.amenities.map((amenity, index) => (
                        <div key={index} className="flex items-center space-x-2 p-2 rounded-lg bg-emerald-50 border border-emerald-100">
                          ...
                          <span className="text-sm text-emerald-700">{amenity}</span>
                        </div>
                      ))}
                    </div>
                  </div>
