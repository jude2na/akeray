...
const notifications = [
	{
		...
		message:
			"ለአበበ ከበደ የክራይ ክፍያ ማስታወሻ ተልኳል / Rent payment reminder sent to Abebe Kebede",
		type: "payment",
		status: "sent",
			...
			<div className="space-y-6">
				...
				<div className="flex items-center justify-between">
					<div>
						...
						<p className="text-gray-600 mt-1">
							ሁሉንም የሲስተም ማሳወቂያዎች ያስተዳድሩ / Manage all system notifications
						</p>
					</div>
					<Button
						asChild
							...
							<div className="flex items-center space-x-2">
								...
								<div>
									...
									<p className="text-sm text-gray-600">
										ጠቅላላ ማሳወቂያዎች / Total Notifications
									</p>
								</div>
							</div>
						</CardContent>
					...
					<div className="flex space-x-2">
						<DropdownMenu>
							...
							<DropdownMenuContent align="end">
								...
								<DropdownMenuItem onClick={() => setFilterType("lease")}>
									ውል / Lease
								</DropdownMenuItem>
							</DropdownMenuContent>
						</DropdownMenu>
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							ሁሉም የተላኩ እና በመጠባበቅ ላይ ያሉ ማሳወቂያዎች / All sent and pending
							notifications
						</CardDescription>
					</CardHeader>
					<CardContent>
											...
											<TableCell className="text-right">
												<div className="flex items-center justify-end space-x-2">
													<Button variant="ghost" size="sm" asChild>
														<Link
															href={`/dashboard/admin/notifications/${notification.id}`}
														>
