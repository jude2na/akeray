...
import { ArrowLeft, Save, User, Mail, Phone, MapPin, Building, Shield } from "lucide-react"
...
export default function NewUserPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false)
      toast({
        title: "ተጠቃሚ ተጨምሯል / User Added Successfully",
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold bg-gradient-to-r from-emerald-600 to-blue-600 bg-clip-text text-transparent">
                አዲስ ተጠቃሚ ጨምር / Add New User
              </h1>
              <p className="text-gray-600 mt-1">አዲስ ተጠቃሚ መረጃ ያስገቡ / Enter new user information</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-center">
                  <Avatar className="h-24 w-24 ring-4 ring-emerald-200">
                    <AvatarImage src={formData.profileImage || "/placeholder-user.jpg"} />
          ...
          <div className="flex justify-end space-x-4">
            <Button variant="outline" type="button" asChild>
              <Link href="/dashboard/admin/users">ተወው / Cancel</Link>
            </Button>
            <Button
              type="submit"
